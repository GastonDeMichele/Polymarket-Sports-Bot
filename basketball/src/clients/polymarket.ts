...
/**
 * Single-event moneyline: one market, two outcomes, two YES token ids (Polymarket NBA/CBA style).
 * Team order matches event slug segments after the league prefix (e.g. nba-hou-lal → [hou, lal]).
 */
